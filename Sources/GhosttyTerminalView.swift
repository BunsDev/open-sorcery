...
final class GhosttySurfaceScrollView: NSView {
    ...
    init(surfaceView: GhosttyNSView) {
        ...
        // Attention ring uses the cmux accent (matches sidebar selection,
        // drop indicators, etc.) rather than systemBlue so the visual system
        // feels cohesive.
        let ringAccent = cmuxAccentNSColor()
        notificationRingLayer.fillColor = NSColor.clear.cgColor
        notificationRingLayer.strokeColor = ringAccent.cgColor
        ...
        notificationRingLayer.shadowColor = ringAccent.cgColor
        notificationRingLayer.shadowOpacity = 0.5
        notificationRingLayer.shadowRadius = 4
